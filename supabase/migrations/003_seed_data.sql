...
INSERT INTO packages (name, duration_hours, price, description, is_active) VALUES
  ('24 Hours', 24, 50.00, 'Get unlimited WiFi access for 24 hours. Perfect for short-term use.', true),
  ('30 Days', 720, 1500.00, 'Get unlimited WiFi access for 30 days. Best value for regular users.', true);
